...
-- Insertion des catégories uniques
INSERT INTO `ProjPy`.`categorie` (`categories_name`) 
VALUES ('Électronique'), ('Vêtements'), ('Chaussures'), ('Coiffure'), ('Accessoires');
...
-- Insertion des statuts de paiement uniques
INSERT INTO `ProjPy`.`payment_status` (`status_name`) 
VALUES ('En attente'), ('Validé'), ('Échoué');
...
-- Insertion des statuts de livraison uniques
INSERT INTO `ProjPy`.`delivery_status` (`statut_type`) 
VALUES ('En préparation'), ('Expédié'),('En transit'), ('Livré');
